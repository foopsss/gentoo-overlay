...
src_prepare() {
	...
	sed -i 's!Icon=/usr/share/icons/onedriver/onedriver.svg!Icon=/usr/share/pixmaps/onedriver.svg!' pkg/resources/onedriver-launcher.desktop || die "Icon location couldn't be changed in onedriver-launcher.desktop!"
